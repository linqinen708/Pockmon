...
//        mList = getDBHelper().queryData()
    ...
    fun initData() {
        ...
        pockmonAdapter?.items?.add(PockmonBean(361,"始祖大树", 62, "绿", "52", "46", "34", 260, 185))
        pockmonAdapter?.items?.add(PockmonBean(362,"始祖大树", 62, "蓝", "58", "52", "38", 289, 201))
        pockmonAdapter?.items?.add(PockmonBean(363,"始祖大树", 70, "蓝", "63", "57", "42", 321, 222))
